...
As you can see from the above code we have an example and very basic Hight Order Component called `withHOC`. This creates a layout and generic H1 for us and then renders our `WrappedComponent`.

Using the `render` method directly passing this in won't work. We have to instead do a bit of setup.

On *line 22* we create a, what I have called, Mock App with some basic html in it. We will use this to be able to wrap our Higher Order Component around it. We do this on *line 30*.
